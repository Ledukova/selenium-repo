            ...
            for i in range(0, len(my_list)):
                ...
                if len(price_list)==0:
                    ...
                    if name_glogal not in tovar:
                        ...
                        print("начальная цена товара на главной странице- ", prise1_glogal)
                        print("акционная цена товара на главной странице- ", prise2_glogal)
                        ...
                        print("начальная цена товара на странице товара- ", prise1_local)
                        ...
                        print("акционная цена товара на странице товара- ", prise2_local)
                    ...
                    if name_glogal not in tovar:
                        tovar.append(name_glogal)
                        print("цена на главной странице: ", price_global)
                        name=my_list[i].find_element_by_css_selector(".name").click() # нажать на товар, для перехода на страницу товара
                        price_local=driver.find_element_by_css_selector(".information .price").get_attribute("textContent") # цена на странице товара
                        print("цена на странице товара: ", price_local)
